...
def overlapping_eval(spots,positions,fovs,pix_size):
    ...
    offset_translation_enlarge = offset_df[(offset_df['translations']>10) & (offset_df['translations']<13)]
    fig,ax = plt.subplots()
    plt.hist(offset_df['translations'], color='black', bins=50)
    plt.ylabel("Coutns",fontname="Arial", fontsize=20)
    plt.xlabel("Translations[um]", fontname="Arial",fontsize=20)
    plt.xticks(fontsize=18,fontname="Arial")
    plt.yticks(fontsize=18,fontname="Arial")
    plt.show()
    
    fig,ax = plt.subplots()
    plt.hist(offset_translation_enlarge['translations'], color='black', bins=30)
    ...
    fig,ax = plt.subplots()
    plt.scatter(offset_df['dup_spots'],offset_df['dup_ratio'], s= 15,c = offset_df['translations'],cmap='gist_rainbow',vmin=0,vmax=100)
    cbar = plt.colorbar()
    tick_font_size = 18
    cbar.ax.tick_params(labelsize=tick_font_size)
    cbar.set_label('Translation [um]', rotation=270,fontsize=18)
    plt.ylabel("Ratio", fontsize=20)
    plt.xlabel("Duplicated spot pairs", fontsize=20)
    plt.xticks(np.arange(0,2300,500),fontsize=18)
    plt.yticks(np.arange(0,1.01,0.2),fontsize=18)
    
    plt.show()
    
    fig,ax = plt.subplots()
    plt.scatter(offset_non_cred_enlarge['dup_spots'],offset_non_cred_enlarge['dup_ratio'], s= 40,c = offset_non_cred_enlarge['translations'],cmap='gist_rainbow',vmin=0,vmax=100)
    cbar = plt.colorbar()
    tick_font_size = 18
    cbar.ax.tick_params(labelsize=tick_font_size)
    plt.ylabel("Ratio", fontsize=20)
    ...
    fig,ax = plt.subplots()
    plt.scatter(offset_df['dup_spots'],offset_df['ncc'], s= 15,c = offset_df['translations'],cmap='gist_rainbow',vmin=0,vmax=100)
    cbar = plt.colorbar()
    tick_font_size = 18
    cbar.ax.tick_params(labelsize=tick_font_size)
    cbar.set_label('Translation [um]', rotation=270,fontsize=18)
    ...
    fig,ax = plt.subplots()
    plt.scatter(offset_cred['dup_spots'],offset_cred['dup_ratio'], s= 15,c = 'lightskyblue',label = 'Credible')
    plt.scatter(offset_non_cred['dup_spots'],offset_non_cred['dup_ratio'], s= 15,c = 'black', label = 'Non-credible')
    plt.ylabel("Ratio", fontsize=20)
    plt.xlabel("Duplicated spot pairs", fontsize=20)
    plt.xticks(np.arange(0,2300,500),fontsize=18)
    plt.yticks(np.arange(0,1.01,0.2),fontsize=18)
    ...
    fig,ax = plt.subplots()
    plt.scatter(offset_cred['dup_spots'],offset_cred['ncc'], s= 15,c = 'lightskyblue',label = 'Credible')
    plt.scatter(offset_non_cred['dup_spots'],offset_non_cred['ncc'], s= 15,c = 'black', label = 'Non-credible')
    plt.ylabel("NCC", fontsize=20)
    plt.xlabel("Duplicated spot pairs", fontsize=20)
    plt.xticks(np.arange(0,2300,500),fontsize=18)
    plt.yticks(np.arange(0,1.01,0.2),fontsize=18)
...
#parameters set-up
    save_folder_lsit = [r'\\core-server.igb.illinois.edu\groups\hshan\sy44\fine_alignment_iteration_datasets\raw_test\20220630_cs3']
    ...
    for save_folder in save_folder_lsit:
        for file in os.listdir(save_folder):
            if 'position' in file:
                positions = pd.read_csv(save_folder + '/' + file, header=None, names=["x", "y"])
        ...
        spot_folder = save_folder + '/merlin_output'
        for file in os.listdir(spot_folder):
            if 'warped' in file:
                spots=pd.read_csv(spot_folder + '/' + file)
        ...
        offset_cred.to_csv(save_folder + '/offsets_cred_0rnd.csv')
